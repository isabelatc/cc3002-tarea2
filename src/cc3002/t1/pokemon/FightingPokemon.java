...
/**
 * Class of the fighting pokémon cards. It inherites methods from its abstract superclass AbstractPokemon.
 *
...
public class FightingPokemon extends AbstractPokemon {
    ...
    public boolean equals(Object o) {
        if (o instanceof FightingPokemon) {
            return (((FightingPokemon) o).getCardName()).equals(this.getCardName()) &&
                    ...
                    (((FightingPokemon) o).getEnergyList()).equals(this.getEnergyList());
        }
        return false;
    }
    ...
    public void attack(IPokemon other) {
        if (this.canAttack()) {
            other.attackedByFightingPokemon(this.getSelectedAttack());
        }
    }
