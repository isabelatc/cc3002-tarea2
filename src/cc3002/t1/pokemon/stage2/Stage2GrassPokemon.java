...
/**
 * Class for every stage 2 grass pokémon.
 *
...
public class Stage2GrassPokemon extends AbstractGrassPokemon implements IStage2Pokemon {
    ...
    /**
     * The constructor of a stage 2 grass pokémon. Initially, some of its parameters are empty, because they will be
     ...
     */
    public Stage2GrassPokemon(String name, int id, int hp, ArrayList<IAbility> abilityList, int preEvolutionID) {
    ...
    public boolean equals(Object o) {
        if (o instanceof Stage2GrassPokemon) {
            return (((Stage2GrassPokemon) o).getCardName()).equals(this.getCardName()) &&
                    ...
                    (((Stage2GrassPokemon) o).getAbilityList()).equals(this.getAbilityList()) &&
