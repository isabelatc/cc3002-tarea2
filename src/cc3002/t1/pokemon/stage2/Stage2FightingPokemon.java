...
/**
 * Class for every stage 2 fighting pokémon.
 *
...
public class Stage2FightingPokemon extends AbstractFightingPokemon implements IStage2Pokemon {
    ...
    /**
     * The constructor of a stage 2 fighting pokémon. Initially, some of its parameters are empty, because they will be
     ...
     */
    public Stage2FightingPokemon(String name, int id, int hp, ArrayList<IAbility> abilityList, int preEvolutionID) {
    ...
    public boolean equals(Object o) {
        if (o instanceof Stage2FightingPokemon) {
            return (((Stage2FightingPokemon) o).getCardName()).equals(this.getCardName()) &&
                    ...
                    (((Stage2FightingPokemon) o).getAbilityList()).equals(this.getAbilityList()) &&
