...
/**
 * Class for a generic fighting pokémon.
 *
...
public abstract class AbstractFightingPokemon extends AbstractPokemon implements IPokemon {
    ...
    /**
     * Constructor of a generic fighting Pokémon card.
     *
     ...
     */
    public AbstractFightingPokemon(String name, int id, int hp, ArrayList<IAbility> abilityList) {
    ...
    public void usesAbility() {
        if (this.canUseAbility()) {
            this.getSelectedAbility().usedByFightingPokemon();
        }
    }
