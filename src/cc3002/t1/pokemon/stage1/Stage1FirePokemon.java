...
/**
 * Class for every stage 1 fire pokémon.
 *
...
public class Stage1FirePokemon extends AbstractFirePokemon implements IStage1Pokemon {
    ...
    /**
     * The constructor of a stage 1 fire pokémon. Initially, some of its parameters are empty, because they will be
     ...
     */
    public Stage1FirePokemon(String name, int id, int hp, ArrayList<IAbility> abilityList, int preEvolutionID) {
    ...
    public boolean equals(Object o) {
        if (o instanceof Stage1FirePokemon) {
            return (((Stage1FirePokemon) o).getCardName()).equals(this.getCardName()) &&
                    ...
                    (((Stage1FirePokemon) o).getAbilityList()).equals(this.getAbilityList()) &&
