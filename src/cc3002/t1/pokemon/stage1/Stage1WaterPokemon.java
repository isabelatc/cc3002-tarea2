...
/**
 * Class for every stage 1 water pokémon.
 *
...
public class Stage1WaterPokemon extends AbstractWaterPokemon implements IStage1Pokemon {
    ...
    /**
     * The constructor of a stage 1 water pokémon. Initially, some of its parameters are empty, because they will be
     ...
     */
    public Stage1WaterPokemon(String name, int id, int hp, ArrayList<IAbility> abilityList, int preEvolutionID) {
    ...
    public boolean equals(Object o) {
        if (o instanceof Stage1WaterPokemon) {
            return (((Stage1WaterPokemon) o).getCardName()).equals(this.getCardName()) &&
                    ...
                    (((Stage1WaterPokemon) o).getAbilityList()).equals(this.getAbilityList()) &&
